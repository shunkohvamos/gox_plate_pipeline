...
- Raw FoG (`fog_raw`) selects PMTAC top in 1 run(s) among evaluable runs.
- Constrained objective with `theta=0.70` reduces PMTAC top picks to 0 and selects PMBTA top in 5 run(s).
